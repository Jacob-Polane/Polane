...
namespace polane.Polane.Common.Authorization
{
    /// <summary>
    /// Polane Permission checker
    /// </summary>
    public class PolanePermissionChecker : ICustomPermissionChecker, IPolanePermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public PolanePermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
