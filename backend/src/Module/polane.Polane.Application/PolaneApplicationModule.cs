...
namespace polane.Polane.Application
{
    ...
    public class PolaneApplicationModule : SheshaSubModule<PolaneModule>
    {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore().CreateControllersForAppServices(
               typeof(PolaneApplicationModule).Assembly,
               moduleName: "Polane",
                useConventionalHttpVerbs: true);

            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(PolaneModule).GetAssembly()
                 );

            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(PolaneApplicationModule).GetAssembly()
                 );
        }
    }
}
