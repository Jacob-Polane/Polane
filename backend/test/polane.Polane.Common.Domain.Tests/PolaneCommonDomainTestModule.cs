...
using polane.Polane.Tests.DependencyInjection;
using Shesha;
...
namespace polane.Polane.Common.Tests
{
    [DependsOn(
        typeof(PolaneModule),
    ...
    public class PolaneCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public PolaneCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
